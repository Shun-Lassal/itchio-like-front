...
<template>
  <div class="flex flex-col shadow-xl bg-gray-200 rounded">
    <img src="https://picsum.photos/350/175" alt="" class="rounded-t" />
    <div class="flex flex-col">
      <div class="flex justify-between items-center p-1">
        <span class="font-semibold">{{ gameTitle }}</span>
        <span class="bg-gray-500 p-1 border rounded text-white"
          >{{ price }} €</span
        >
      </div>
      <div class="flex px-1">
        <span class="text-gray-500">{{ category1 }} - {{ category2 }}</span>
      </div>
